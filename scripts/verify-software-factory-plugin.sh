...
require_file "$PLUGIN_DIR/skills/software-factory/sofa-rws.md"
require_file "$PLUGIN_DIR/skills/software-factory/sofa-bws.md"
require_file "$PLUGIN_DIR/skills/software-factory/scripts/checklist-template.md"
require_file "$PLUGIN_DIR/skills/software-factory/scripts/context-template.md"
require_file "$PLUGIN_DIR/skills/software-factory/scripts/implementation-plan-template.md"
require_file "$PLUGIN_DIR/skills/software-factory/scripts/review-log-template.md"
require_file "$PLUGIN_DIR/skills/software-factory/scripts/init-wo-execution.sh"
